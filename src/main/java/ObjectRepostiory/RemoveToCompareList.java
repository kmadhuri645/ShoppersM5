...
public class RemoveToCompareList {
	
	public RemoveToCompareList(WebDriver driver) {
	...
	private WebElement RemoveToCompareList1;
	
	public WebElement getRemoveToCompareList2() {
		return RemoveToCompareList2;
	}

	@FindBy(xpath = "//input[@title='Remove']")
	private WebElement RemoveToCompareList2;

	public WebElement getRemoveToCompareList1() {
		return RemoveToCompareList1;
	}
